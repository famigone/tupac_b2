import { _getPropertyModel as _getPropertyModel_1, ArrayModel as ArrayModel_1, makeObjectEmptyValueCreator as makeObjectEmptyValueCreator_1, NotBlank as NotBlank_1, NotNull as NotNull_1, NumberModel as NumberModel_1, ObjectModel as ObjectModel_1, StringModel as StringModel_1 } from "@hilla/form";
...
class DesafioModel<T extends Desafio_1 = Desafio_1> extends AbstractEntityModel_1<T> {
    ...
    get orden(): ObjectModel_1 {
        return this[_getPropertyModel_1]("orden", (parent, key) => new ObjectModel_1(parent, key, false, { validators: [new NotBlank_1(), new NotNull_1()], meta: { javaType: "java.lang.Number" } }));
    }
    get tpId(): NumberModel_1 {
        return this[_getPropertyModel_1]("tpId", (parent, key) => new NumberModel_1(parent, key, false, { validators: [new NotBlank_1(), new NotNull_1()], meta: { javaType: "java.lang.Long" } }));
    }
}
